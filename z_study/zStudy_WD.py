...
def objective(trial):
    ...
    name = f"wd_zStudy-zdim_{zdim}_trial_{trial.number}"
...
def run(zdim):
    ...
    study = optuna.create_study(direction="minimize", 
                                study_name=f"zStudy - zdim {zdim} - Optimizing the VAE with WD", 
    ...
    if zdim == 65:
        study.optimize(objective, n_trials=88)
    else:
...
if __name__ == "__main__":
    ...
    zdims = [65,75,85,95]#[5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 60, 70, 80, 90, 100]
